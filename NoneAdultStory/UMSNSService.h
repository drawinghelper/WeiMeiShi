...
/** 
 ...
 This method share message to renr/tenc/sina, and the shared message will become a new status
...
+ (void) share:(UIViewController *)controller andAppkey:(NSString *)appkey andStatus:(NSString *)newStatus;

/** @name ShareImageAndTextWithoutTemplate */

/** 
 
 This method share image and message to renr/tenc/sina, and the image will uploaded to the user Album
 
 @param  viewController current view controller
 @param  appkey appkey get from www.umeng.com
 @param  newStatus message to be shared
 @param  image the image be shared
 
 */

+ (void) share:(UIViewController *)controller andAppkey:(NSString *)appkey andStatus:(NSString *)newStatus andImageToShare:(UIImage *)image ;
...
+ (void) share:(UIViewController *)controller andAppkey:(NSString *)appkey andShareMap:(NSDictionary *)shareMap;

/** @name ShareImageAndTextUsingTemplate */

/** 
 
 This method share image and message to renr/tenc/sina
 content of the message get according to the share template set on www.umeng.com and shareMap
...
+ (void) share:(UIViewController *)controller andAppkey:(NSString *)appkey andShareMap:(NSDictionary *)shareMap andImageToShare:(UIImage *)image;
...
+ (void) shareToRenr:(UIViewController *)viewController andAppkey:(NSString *)appkey andStatus:(NSString *)newStatus andImageToShare:(UIImage *)image;
...
+ (void) shareToSina:(UIViewController *)viewController andAppkey:(NSString *)appkey andStatus:(NSString *)newStatus andImageToShare:(UIImage *)image;
...
+ (void) shareToTenc:(UIViewController *)viewController andAppkey:(NSString *)appkey andStatus:(NSString *)newStatus andImageToShare:(UIImage *)image;
...
+ (void) shareToRenr:(UIViewController *)viewController andAppkey:(NSString *)appkey andShareMap:(NSDictionary *)shareMap andImageToShare:(UIImage *)image;
...
+ (void) shareToSina:(UIViewController *)viewController andAppkey:(NSString *)appkey andShareMap:(NSDictionary *)shareMap andImageToShare:(UIImage *)image;
...
+ (void) shareToTenc:(UIViewController *)viewController andAppkey:(NSString *)appkey andShareMap:(NSDictionary *)shareMap andImageToShare:(UIImage *)image;
...
/** 
 ...
 @return UMReturnStatusType
 */
+ (UMReturnStatusType) update:(UMShareToType)to andAppkey:(NSString *)appkey andUid:(NSString *)uid andStatus:(NSString *)newStatus andImageToShare:(UIImage *)image error:(NSError *)error;
...
/** 
 ...
 @return UMReturnStatusType
 */
+ (UMReturnStatusType) update:(UMShareToType)to andAppkey:(NSString *)appkey andUid:(NSString *)uid andShareMap:(NSDictionary *)shareMap andImageToShare:(UIImage *)image error:(NSError *)error;
...
/** 
 ...
 This method return the uid for the current user for the selected platform, based on local saved data
 
 @param  to platform type
 
 @return mark for a oauthed user
 */

+ (NSString *) getUidLocal:(UMShareToType)to;
...
/** 
 ...
 @return void
 */
+ (void) writeOffAccounts:(UMShareToType)userPlatform;

/** 
 
 This method set the text count check on or off, default is on, that is text count will be checked before sending, if the text count exceeds the limit(140), send will be canceled.
 
 currently no special check for url
 
 @param value YES for text count check, NO for not check
 */

+ (void)setTextCountCheckEnabled:(BOOL)value;

+ (void)setPriviteMsgInvitationEnabled:(BOOL)value;
...
/** 
 ...
 @param  to platform releated to the uid
 @param  uid mark for a oauthed user, can get from the oauth delegate method or getUid method
 @param  targetId uid for another user
 @param  error nil if successfully finished, else error occured
 
 @return result, nil when error occured
 */

+ (NSString *) getFriendship:(NSString *)appkey andToPlatform:(UMShareToType) to andUid:(NSString *)uid andTargetId:(NSString *)targetId error:(NSError *)error;
...
+ (NSString *) CreateFriendship:(NSString *)appkey andToPlatform:(UMShareToType) to andUid:(NSString *)uid andTargetId:(NSString *)targetId error:(NSError *)error;
...
/** 
 ...
 This method return a bool result to indicate whether show invitation button on the bottom of the main page
 
 @param  platfrom all the three possible value: UMShareToTypeRenr, UMShareToTypeSina, UMShareToTypeTenc
 
 @result YES to show, No to not show
