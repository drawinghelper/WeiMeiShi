...
- (void)viewDidLoad
{
    ...
    _mTableView =  [[UMUFPTableView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height-44) style:UITableViewStylePlain appkey:@"4fffced85270157a3c00004e" slotId:nil currentViewController:self];
